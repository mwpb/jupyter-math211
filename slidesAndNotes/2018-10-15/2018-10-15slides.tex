...
\column{0.5\textwidth}
\begin{itemize}
\item Let $P$ be a point on the line and $n$ a normal vector to the line.
\item For every point $Q$ on the line the vector $\overrightarrow{PQ}$ is orthogonal to $n$.
...
\begin{frame}{Example}
    \begin{example}
        ...
        \end{array}
          \right]
        \end{equation*}
        to the line with equation $5x+y = -2$.
      \end{example}
    \begin{example}
    Find the shortest distance from the point
    \begin{equation*}
